...
cnvkit.py call ${CNVkit_ANALYSIS_PATH}/${SAMPLE}"-TD.cns" --filter cn -o ${CNVkit_ANALYSIS_PATH}/${SAMPLE}-TD_cn.call.cns
cnvkit.py call ${CNVkit_ANALYSIS_PATH}/${SAMPLE}"-TD.cns" --filter ci -o ${CNVkit_ANALYSIS_PATH}/${SAMPLE}-TD_ci.call.cns
cnvkit.py call ${CNVkit_ANALYSIS_PATH}/${SAMPLE}"-TD.cns" --filter ampdel -o ${CNVkit_ANALYSIS_PATH}/${SAMPLE}-TD_ampdel.call.cns
