...
DataPath=/data/project/TRIUMPH/4.analysis/GATK/Mutect2/vcfs
...
SubPath=/data/project/TRIUMPH/4.analysis/GATK/Mutect2/vcfs/hg19vcfs
if [ ! -d $SubPath ]
then
    	mkdir -p $SubPath
fi
...
do
    ...
    ##liftover
    sleep 0.1 | qsub -e $TEMP -o $TEMP -N 'v2m'$SAMPLE ${SCRIPT}/pipe_liftover.sh ${DataPath}/${VCF_LIST[idx]} ${SAMPLE} ${SubPath}
