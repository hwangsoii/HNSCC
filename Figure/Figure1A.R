...
lgd <- list(Legend(labels = names(alter_fun)[2:length(alter_fun)], title = "Alteration", labels_gp = gpar(fontsize = 20),
            ...
            Legend(labels = c("Positive", "Negative"), title = "HPV", labels_gp = gpar(fontsize = 20),
...
pdf("/Users/hwangso_macmini/Google Drive/My Drive/Work/project/HNSCC_2/Figure/Fig1A.pdf", width = 35, height = 15)
