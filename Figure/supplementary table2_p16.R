...
H15_inter_p16posi <- H15_inter[H15_inter$final_HPV =='Positive',]
res.cox <- coxph(Surv(OS_TIME1, DEATH) ~ TP53_total + CDKN2A_total + NOTCH1_total , data=H15_inter_p16posi)
summary(res.cox)
H15_inter_p16nega <- H15_inter[H15_inter$final_HPV =='Negative',]
res.cox <- coxph(Surv(OS_TIME1, DEATH) ~ TP53_total + CDKN2A_total + NOTCH1_total , data=H15_inter_p16nega)
summary(res.cox)
